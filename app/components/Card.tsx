...
const Card: React.FC<CardProps> = (
    ...
    return (
        <div ref={container} className='h-screen  flex items-center justify-center sticky top-32 md:top-0'>
            <motion.div style={{ scale, top: `calc(-5vh + ${i * 25}px)` }} className='flex  flex-col relative -top-[25%] card text-white md:h-[690px] h-screen w-[90vw]  md:w-[80vw] rounded-2xl p-[50px] origin-top'>
